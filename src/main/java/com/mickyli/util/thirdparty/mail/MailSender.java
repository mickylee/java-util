package com.mickyli.util.thirdparty.mail;
...
public class MailSender {
	...
	public static void main(String[] args) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        mailInfo.setFromNickName("mickyli网站");
        mailInfo.setUserName("test@163.com"); // 实际发送者  
        mailInfo.setPassword("*******");// 您的邮箱密码  
        mailInfo.setFromAddress("test@163.com"); // 设置发送人邮箱地址  
        mailInfo.setToAddress("****@qq.com"); // 设置接受者邮箱地址,多个收件人逗号隔开  
        mailInfo.setSubject("Ant测试");  
        mailInfo.setContent("这里是邮件正文");
