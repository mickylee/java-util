package com.mickyli.util.java.character;
...
import com.mickyli.util.java.valid.ValidUtil;
...
public class StringUtil {
    ...
    public static double SimilarityRatio(String str1, String str2) {
        ...
        if (str1.length() > str2.length()) {
            return StringAlgorithmUtil.SimilarityRatio(str1, str2);
        } else {
            return StringAlgorithmUtil.SimilarityRatio(str2, str1);
        }
    ...
    public static double SimilarDegree(String str1, String str2) {
        ...
        str2 = StringUtil.trimPunct(str2);
        if (str1.length() > str2.length()) {
            return StringAlgorithmUtil.SimilarDegree(str1, str2);
        } else {
            return StringAlgorithmUtil.SimilarDegree(str2, str1);
        }
    }
    ...
    public static String cpDetector(String str) {
        ...
        return StringAlgorithmUtil.encoding(str);
    }
