...
import com.mickyli.util.java.CpDetector;
import com.mickyli.util.java.project.CharsetUtil;
import com.mickyli.util.java.system.SysUtil;

/**
 * 对比俩个字符串的相似度
 */
public class StringAlgorithmUtil {
    //第一种实现方式
