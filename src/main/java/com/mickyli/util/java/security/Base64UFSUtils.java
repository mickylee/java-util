...
/** 
 *   <B>说       明</B>:Base64(URL And FileName Safe)工具类。
 *   
 */
public class Base64UFSUtils {

	/**
	 * 对数据进行Base64(URL And FileName Safe)编码。
	 * 
	 * @param data 待编码的数据。
	 * @return
	 *      编码后的数据。
	...
	/**
	 * 对数据进行Base64(URL And FileName Safe)编码，以字符串形式返回。
	 * 
	 * @param data 待编码的数据。
	 * @return
	 *      编码后的数据。
	...
	/**
	 * 对数据进行Base64(URL And FileName Safe)解码。
	 * 
	 * @param data 待解码的数据。
	 * @return
	 *      解码后的数据。
	...
	/**
	 * 对数据进行Base64(URL And FileName Safe)解码。以字符串形式返回。
	 * 
	 * @param data 待解码的数据。
	 * @param charset 字符集。
	 * @return
