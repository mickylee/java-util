package com.mickyli.util.java.file;
...
import com.mickyli.util.java.security.SecUtil;
import com.mickyli.util.java.valid.RegUtil;
...
public class FileUtil {
    ...
    public static String cpdetector(File file) {
        try {
            return FileAlgorithmUtil.cpdetector(file.toURL());
    ...
    public static String simpleEncoding(String file) {
        try {
            return FileAlgorithmUtil.simpleEncoding(file);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
